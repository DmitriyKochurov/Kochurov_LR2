while True:
    while True:
        limns_1 = list(input("Please, input line and columns matrix A: \n"))
        column_1 = int(limns_1[0])
        line_1 = int(limns_1[2])
        matrix_1 = []
        line_true_a = 0
    ...
    while True:
        limns_2 = list(input("Please, input line and columns matrix B: \n"))
        column_2 = int(limns_2[0])
        line_2 = int(limns_2[2])
        matrix_2 = []
        line_true_b = 0
